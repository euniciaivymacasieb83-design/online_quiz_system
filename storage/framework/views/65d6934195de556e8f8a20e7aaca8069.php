            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <li><a href="<?php echo e(route('profile.edit')); ?>" class="hover:text-white transition">Profile</a></li>
                    <?php endif; ?>
                </ul>
            </div>
...
<?php /**PATH C:\Users\User\Herd\online_quiz_system\resources\views/components/footer.blade.php ENDPATH**/ ?>