...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <?php if(Route::has('password.request')): ?>
                            <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-blue-600 hover:text-blue-800 font-semibold transition">
                                Forgot password?
                            </a>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="relative my-6">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-2 bg-white text-gray-500">New to QuizMaster?</span>
                        </div>
                    </div>
                ...
                <div class="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <div class="text-xs text-gray-700 space-y-1">
                        <p><strong>Teacher:</strong> john.smith@example.com</p>
                        <p><strong>Student:</strong> alice.brown@example.com</p>
        ...
        <div class="mt-8 text-center text-white">
            <p class="text-sm">Having trouble? <a href="mailto:support@quizmaster.com" class="underline hover:text-blue-100 transition">Contact Support</a></p>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\User\Herd\online_quiz_system\resources\views/auth/login.blade.php ENDPATH**/ ?>